...
namespace xenomods {
	...
	enum class Keybind : std::uint64_t {
		...
		FREECAM_HANDLE = nn::hid::KEY_L | nn::hid::KEY_R,

		FREECAM_FOVRESET = FREECAM_HANDLE | nn::hid::KEY_LSTICK,
		FREECAM_ROTRESET = FREECAM_HANDLE | nn::hid::KEY_RSTICK,
		FREECAM_SPEED_UP = FREECAM_HANDLE | nn::hid::KEY_DUP,
		FREECAM_SPEED_DOWN = FREECAM_HANDLE | nn::hid::KEY_DDOWN,
		FREECAM_TELEPORT = FREECAM_HANDLE | nn::hid::KEY_B,
