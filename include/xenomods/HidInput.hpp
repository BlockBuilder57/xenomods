...
namespace xenomods {
	...
	enum class Keybind : std::uint64_t {
		...
		RENDER_TOGGLE_1 = CAMERA_COMBO | nn::hid::KEY_DUP,
		RENDER_TOGGLE_2 = CAMERA_COMBO | nn::hid::KEY_DLEFT,
		RENDER_TOGGLE_3 = CAMERA_COMBO | nn::hid::KEY_DRIGHT,
		RENDER_TOGGLE_4 = CAMERA_COMBO | nn::hid::KEY_DDOWN,
		RENDER_TOGGLE_5 = CAMERA_COMBO | nn::hid::KEY_Y,
		RENDER_TOGGLE_6 = CAMERA_COMBO | nn::hid::KEY_X,
		RENDER_TOGGLE_7 = CAMERA_COMBO | nn::hid::KEY_A,
	};
