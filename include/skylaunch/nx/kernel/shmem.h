 ...
 * @remark Shared memory differs from transfer memory in the fact that the kernel (as opposed to the user process)
 ...
 * @param remote_perm Permissions with which the shared memory object will be mapped in the remote process (can be
 * Perm_DontCare).
 * @return Result code.
