...
#include "skylaunch/nx/sf/service.h"
...
#define nnServiceDispatch(_s, _rid, ...) \
    skylaunch::utils::ServiceDispatchImpl((_s), (_rid), NULL, 0, NULL, 0, (SfDispatchParams){__VA_ARGS__})

#define nnServiceDispatchIn(_s, _rid, _in, ...) \
    skylaunch::utils::nnServiceDispatchImpl((_s), (_rid), &(_in), sizeof(_in), NULL, 0, (SfDispatchParams){__VA_ARGS__})

#define nnServiceDispatchOut(_s, _rid, _out, ...)                                       \
    skylaunch::utils::nnServiceDispatchImpl((_s), (_rid), NULL, 0, &(_out), sizeof(_out), \
                                          (SfDispatchParams){__VA_ARGS__})

#define nnServiceDispatchInOut(_s, _rid, _in, _out, ...)                                            \
    skylaunch::utils::nnServiceDispatchImpl((_s), (_rid), &(_in), sizeof(_in), &(_out), sizeof(_out), \
                                          (SfDispatchParams){__VA_ARGS__})
