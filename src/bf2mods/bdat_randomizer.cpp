...
namespace Bdat {
	...
	GENERATE_SYM_HOOK(getMSText, "_ZN4Bdat9getMSTextEPhi", const char*, std::uint8_t* bdatData, int n) {
		...
		switch(bf2mods::Plugin::getSharedStatePtr()->options.bdat.scrambleType) {
			case bf2mods::SharedState::Options::BdatOptions::ScrambleType::ScrambleIndex:
				...
				break;
			case bf2mods::SharedState::Options::BdatOptions::ScrambleType::ShowSheetName:
				message = sheetName;
				break;
			case bf2mods::SharedState::Options::BdatOptions::ScrambleType::Off:
			default:
