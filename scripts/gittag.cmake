...
file(APPEND ${VERSION_FILENAME} "namespace ${NAMESPACE} {\n")

file(APPEND ${VERSION_FILENAME} "\tconstexpr static char commit[] = \"${GIT_COMMIT}\";\n")
if("${GIT_BRANCH}" STREQUAL "${TRUNK_BRANCH}")
	...
	if("${GIT_TAG}" STREQUAL "${GIT_COMMIT}")
		...
		file(APPEND ${VERSION_FILENAME} "\tconstexpr static char tagDirty[] = \"${GIT_TAG_DIRTY}${GIT_BRANCH}\";\n")
	else()
...
if("${GIT_BRANCH}" STREQUAL "${TRUNK_BRANCH}")
	...
	if("${GIT_TAG}" STREQUAL "${GIT_COMMIT}")
		...
		file(APPEND ${VERSION_FILENAME} "\t#define GIT_TAG_DIRTY \"${GIT_TAG_DIRTY}${GIT_BRANCH}\"\n")
	else()
		# we actually have a tag, so do this instead
